...
type BillingCompanyInsert = Database['public']['Tables']['billing_companies']['Insert'];
...
export default function BillingCompanyForm() {
  ...
  const [formData, setFormData] = useState<BillingCompanyInsert>({
    company_name: '',
    trading_name: '',
    cnpj: '',
    state_registration: '',
  ...
  async function fetchCompany() {
    ...
    try {
      ...
      customToast.error('Erro ao carregar dados da empresa. Por favor, tente novamente.');
    } finally {
      setLoading(false);
    }
  }
  ...
  const handleCNPJChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Também atualiza o campo no formData
    setFormData({
      ...formData,
      cnpj: e.target.value
    });
  ...
  const searchCNPJ = async () => {
    ...
    try {
      ...
      setFormData({
        ...
        trading_name: data.nome_fantasia || data.razao_social,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Error saving billing company:', error);
      customToast.error('Erro ao salvar empresa. Por favor, tente novamente.');
    } finally {
      setSaving(false);
    }
  };
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Digite o CNPJ e clique no botão de busca para preencher automaticamente os dados da empresa.
            </p>
          </div>
